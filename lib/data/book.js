...
/**
 * Maintains an internal collection of
 * {@link module:bfx-api-node-models.OrderBook|OrderBook} models on
 * `state.books`, and emits an event w/ the full book for each update.
 *
 * @memberof module:bfx-api-node-plugin-managed-ob
 * @private
 *
